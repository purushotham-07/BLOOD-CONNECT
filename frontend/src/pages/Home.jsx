...
const FEATURES = [
  {
    title: 'PostgreSQL PostGIS Matching',
    text: 'Accurate spatial distance queries (ST_DWithin & ST_Distance) matching donors within emergency notification radiuses.',
    icon: 'M12 3a7 7 0 0 0-7 7c0 5 5.5 9 7 10.5C13.5 19 19 15 19 10a7 7 0 0 0-7-7Z',
  },
  {
    title: 'Adaptive Blood Compatibility',
    text: 'Centralized component rules for Red Cells, Whole Blood, Platelets, and Plasma that shortlist only compatible donors.',
  ...
  {
    title: 'Real-Time Map & Socket.IO',
    text: 'Interactive Leaflet donor map with instant live notifications when donors accept or new matches enter the radius.',
    ...
    <main>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="mx-auto max-w-3xl text-center">
            <span className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-1.5 text-xs font-bold text-brand-700 shadow-sm ring-1 ring-brand-200">
              ...
              Location-Based Blood Matching & Donor Map
            </span>
            ...
            <p className="mt-5 text-base text-gray-600 sm:text-lg leading-relaxed">
              When a blood request is created, BloodConnect uses PostgreSQL PostGIS to immediately locate, rank, and notify compatible nearby donors on an interactive Leaflet map.
            </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        ...
        <div className="mt-10 rounded-2xl border border-amber-200 bg-amber-50/80 p-5 text-xs text-amber-900">
          <strong>Important Coordination Notice:</strong> BloodConnect provides database-driven geographic coordination to connect nearby donors and requests. Final compatibility and donor eligibility must always be verified by qualified medical and blood-bank personnel before fulfilling donations.
        </div>
      </section>
    </main>
  );
